...
public class CorsiController {
    ...
    void btnCercaIscritti(ActionEvent event) {
    	...
    	//if(statistica!=null) {
//    	for(tatistica. i:statistica) {
//    		txtArea.appendText(i.toString()+"\n");
//    		}
    	//}else txtArea.appendText("Corso di studi non trovato!");
    	}catch (Exception e) {
...
//    	txtArea.clear();
//    	String messaggio=modello.Stampa(modello.listaCorsiSemestre(Integer.parseInt(txtSemestre.getText())));
